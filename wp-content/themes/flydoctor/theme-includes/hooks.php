 ...
 */
function flydoctor_filter_fw_ext_backups_demos( $demos ) {
	$demos_array = array(
		'flydoctor' => array(
			'title'        => esc_html__( 'FlyDoctor', 'flydoctor' ),
			'screenshot'   => 'http://flytemplates.com/demo-themes/images/flydoctor.png',
			'preview_link' => 'http://demo.flytemplates.com/flydoctor/',
		),
	);
...
add_filter( 'fw:ext:backups-demo:demos', 'flydoctor_filter_fw_ext_backups_demos' );
