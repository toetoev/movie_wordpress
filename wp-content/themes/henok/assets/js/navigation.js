...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', henokScreenReaderText.expand); // Make sure all children are closed.
    ...
    toggleButton.setAttribute('aria-label', henokScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', henokScreenReaderText.expand);
