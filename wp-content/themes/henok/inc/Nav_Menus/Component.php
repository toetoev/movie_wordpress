<?php
/**
 * Henok\Henok\Nav_Menus\Component class
 *
 * @package Henok
 */

namespace Henok\Henok\Nav_Menus;
 ...
 * * `henok()->is_primary_nav_menu_active()`
 * * `henok()->display_primary_nav_menu( array $args = array() )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			[
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'henok' ),
			]
		);
	}
