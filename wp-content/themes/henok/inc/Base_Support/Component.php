<?php
/**
 * Henok\Henok\Base_Support\Component class
 *
 * @package Henok
 */

namespace Henok\Henok\Base_Support;
 ...
 * * `henok()->get_version()`
 * * `henok()->get_asset_version( string $filepath )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_essential_theme_support() {
		...
		// Add support for the Sportspress plugin.
	...
	public function filter_excerpt_more( $more ) {
		...
		$more = sprintf(
			...
			*/
			'&hellip; <br><a class="read-more" href="%1$s">%2$s<span class="screen-reader-text">%3$s</span></a>',
			esc_url( get_permalink( get_the_ID() ) ),
			__( 'Continue reading ', 'henok' ),
