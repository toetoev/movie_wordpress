<?php
/**
 * Henok\Henok\Customizer\Component class
 *
 * @package Henok
 */

namespace Henok\Henok\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'lazy_load_options',
			array(
				'title' => __( 'Lazy-load images', 'henok' ),
				'panel' => 'theme_options',
			)
		);
	}
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			...
			[ 'customize-preview' ],
			henok()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
